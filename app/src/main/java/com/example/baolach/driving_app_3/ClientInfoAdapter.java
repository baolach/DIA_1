...
//
//    // constructor
//    public ClientInfoAdapter(Context context, int layout, ) {
//        this.context = context;
//        this.layout = layout;
//        //this.clientlist = clientlist;
//    }
...
//            LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
//            row = inflater.inflate(layout, null);
//            // id values from content_client_info.xml
//            holder.client_name = (TextView) row.findViewById(R.id.thelessonname);
//            holder.client_phone = (TextView) row.findViewById(R.id.thelessondate);
//            holder.client_address = (TextView) row.findViewById(R.id.thelessontime);
//
//            row.setTag(holder);
//        }
//        else
...
//
//        //Client client = clientlist.get(position);
//        holder.client_name.setText(client_name.getName());
//        holder.client_phone.setText(client.getAddress());
//        holder.client_address.setText(client.getAddress());
//
//
